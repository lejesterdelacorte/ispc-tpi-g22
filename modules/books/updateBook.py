...
def updateBook():
    ...
    sql = "UPDATE libro SET titulo=%s, autor=%s, editorial=%s, fecha_publicacion=%s, genero=%s, usuario_id_usuario=%s WHERE ID_libro = %s;"
    values = (titulo, autor, editorial, fecha_publicacion, genero, usuario_id_usuario, ID_libro)
